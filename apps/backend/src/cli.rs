...
#[derive(Debug, Parser)]
#[clap(name = "ORACLE", about = "ORACLE Service")]
pub struct Cli {
    #[clap(flatten)]
    pub base: BaseCli,
...
pub struct BaseCli {
    ...
    #[clap(short, long, env = "ORACLE_ENV", default_value = "dev")]
    pub env: Environment,
}
...
pub struct SharedParams {
    /// Database connection
    #[clap(
        default_value = "postgres://postgres:123456@localhost:5432/oracle?sslmode=disable",
        env = "ORACLE_POSTGRES"
    )]
    pub database_url: String,

    /// Database Pool Size
    #[clap(default_value = "5", env = "ORACLE_POSTGRES_POOL_SIZE")]
